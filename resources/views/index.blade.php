        ...
        <div class=" overflow-auto" style="display: flex">
            <div class=" st">
                <div class="st-container">
                    <div class="story" style="background-image: url('{{asset('images/bush.jpg')}}');background-size: contain">
            ...
            <div class=" st">
                <div class="st-container">
                    <div class="story" style="background-image: url('images/kiridashi.jpg');background-size: contain">
